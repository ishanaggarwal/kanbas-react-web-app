...
<h3>Updating an Item in an Array</h3>
      ...
      <a href={`${API}/${todo.id}/title/${todo.title}`} className="btn btn-primary float-end">
        Update Todo Title </a>
      <input value={todo.id} className="form-control w-25 float-start me-2 border form-border-gray"
        onChange={(e) => setTodo({ ...todo, id: e.target.value })}/>
      <input value={todo.title} className="form-control w-50 float-start border form-border-gray"
             onChange={(e) => setTodo({ ...todo, title: e.target.value }) }/>
      <br /><br /><hr />
      <div>
      <h5>Update complete Status</h5>
      </div>
      ...
      <input value={todo.id} className="form-control w-25 float-start me-2 border form-border-gray"
        onChange={(e) => setTodo({ ...todo, id: e.target.value })}/>
        complete checkbox:
      <input checked={todo.completed} type="checkbox" className="form-check-input border form-border-gray"
      ...
      <input value={todo.id} className="form-control w-25 float-start me-2 border form-border-gray"
        onChange={(e) => setTodo({ ...todo, id: e.target.value })}/>
      <input value={todo.description} className="form-control w-50 float-start border form-border-gray"
